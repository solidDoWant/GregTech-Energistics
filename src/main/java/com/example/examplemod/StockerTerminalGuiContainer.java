...
public class StockerTerminalGuiContainer extends AEBaseGui {
	...
	public void drawFG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
		this.fontRenderer.drawString(I18n.format("gui.examplemod.terminal.stocker"), 8, 6, 4210752);
		this.fontRenderer.drawString(I18n.format("gui.examplemod.terminal.inventory"), 8, this.ySize - 96 + 3, 4210752);
	...
	private void refreshList() {
		...
		for (final String n : this.names) {
			...
			final ArrayList<StockerInformation> clientInventories = new ArrayList<>();
