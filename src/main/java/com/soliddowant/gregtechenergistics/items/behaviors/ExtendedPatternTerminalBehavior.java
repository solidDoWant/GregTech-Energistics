...
public class ExtendedPatternTerminalBehavior implements IItemBehaviour, IPartProvider, IModelProvider {
    @Nonnull
    @Override
    ...
    public IPart getPart(ItemStack stack) {
        return new ExtendedPatternTerminalPart(stack);
    }

    @Override
    public ModelResourceLocation getModel() {
        AEApi.instance().registries().partModels().registerModels(ExtendedPatternTerminalPart.MODELS);
        return new ModelResourceLocation(Tags.MODID + ":part/extendedpattern.terminal");
    }
}
