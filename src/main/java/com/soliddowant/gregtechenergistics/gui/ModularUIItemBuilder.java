...
public class ModularUIItemBuilder extends Builder {
    ...
    // Prevents the currently held item from being removed from the hotbar while GUI
    // is open.
    @Override
    public ModularUI.Builder bindPlayerHotbar(InventoryPlayer inventoryPlayer, TextureArea imageLocation, int x,
            int y) {
        ...
        for (int slot = 0; slot < 9; slot++) {
            ...
            this.widget(
                    new SlotWidget(inventoryWrapper, slot, x + slot * 18, y, !isCurrentlyHeldItem, !isCurrentlyHeldItem)
